...
**EN** — A robust audio delay detection and synchronization tool with a modern dark-themed GUI.

**TR** — Modern karanlık temalı arayüze sahip, güçlü bir ses gecikme tespiti ve senkronizasyon aracı.
